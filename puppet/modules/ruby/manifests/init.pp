...
#  }
 ...
 # }
  ...
  case $operatingsystem {
    "Ubuntu", "Debian": {
      package {['imagemagick','libmagick++-dev','libaugeas-ruby1.9.1','nodejs', 'libmysqlclient-dev', 'libxml2', 'htop',
                'git-core', 'build-essential', 'libssl-dev',
  ...
  package { ['bundler', 'foreman', 'rake', 'backup', 'bluepill','unicorn-rails','facter']:
    ensure => 'installed',
    provider => 'gem',
